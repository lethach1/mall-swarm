...
/**
 * Flash promotion activity management Controller
 * Created by macro on 2018/11/16.
 */
@Controller
@Tag(name = "SmsFlashPromotionController", description = "Flash promotion activity management")
...
public class SmsFlashPromotionController {
    ...
    @Operation(summary = "Edit activity information")
    ...
    @Operation(summary = "Delete activity information")
    ...
    @Operation(summary = "Paginated query by activity name")
